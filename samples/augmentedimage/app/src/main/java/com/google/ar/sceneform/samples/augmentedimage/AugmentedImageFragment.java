...
public class AugmentedImageFragment extends ArFragment {
    ...
    private static final String DEFAULT_IMAGE_NAME2 = "default2.png";
    ...
    private boolean setupAugmentedImageDatabase(Config config, Session session) {
        ...
        if (USE_SINGLE_IMAGE) {
            ...
            Bitmap augmentedImageBitmap2 = loadAugmentedImageBitmap(assetManager, DEFAULT_IMAGE_NAME2);
            Bitmap augmentedImageBitmap3 = loadAugmentedImageBitmap(assetManager, TEST_IMAGE_NAME);
            if (augmentedImageBitmap == null && augmentedImageBitmap2 == null && augmentedImageBitmap3 == null) {
                return false;
            }
            ...
            if (augmentedImageBitmap2 != null) {
                augmentedImageDatabase.addImage(DEFAULT_IMAGE_NAME2, augmentedImageBitmap2);
            }
            if (augmentedImageBitmap3 != null) {
                augmentedImageDatabase.addImage(TEST_IMAGE_NAME, augmentedImageBitmap3);
            }
